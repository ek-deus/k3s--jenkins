...
``` 
cd existing_repo
git remote add origin http://gitlab.ekdeus.local/devops-manual/k3s.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.ekdeus.local/devops-manual/k3s/-/settings/integrations)
